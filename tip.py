...
def first_select(source_folder, target_folder1,target_folder2, mid_folder):
    ...
    for filename in os.listdir(source_folder):
        ...
        if not has_directory:
            ...
            txt_file_path = os.path.join(mid_folder,filename)
...
def directory_select(directory_folder, txt_folder, target_folder):
...
missing_files = directory_select('mid', 'data_txt','qa_txt')
